...
I like what the ECS team has created for ECS Express Mode. You get a lot of value with a limited set of configuration. For getting things up and running fast, I'm  definitely going to use it. It's really great to go from a container image to a production like environment in a matter of minutes. There are still quite some things I want to explore further. The service is quite new so I hope it sees some nice update in the near future like deployment strategy and perhaps custom domain support.
